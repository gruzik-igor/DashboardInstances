 ...
 */
class Version20180817120814 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_906517443A51721D ON invoice (instance_id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_906517443A51721D ON invoice');
