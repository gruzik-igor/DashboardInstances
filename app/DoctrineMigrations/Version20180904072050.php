 ...
 */
class Version20180904072050 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE instance (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, user_ma INT NOT NULL, license_issued INT DEFAULT NULL, license_rate INT DEFAULT NULL, status VARCHAR(255) NOT NULL, deploying_status VARCHAR(255) NOT NULL, deploying_date DATE DEFAULT NULL, domain VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, instance_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, creation_date DATE DEFAULT NULL, status VARCHAR(255) NOT NULL, expiration_date DATE DEFAULT NULL, INDEX IDX_906517443A51721D (instance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, full_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(255) DEFAULT \'ROLE_SUPER_ADMIN\', salt VARCHAR(255) DEFAULT NULL, registration_date DATETIME DEFAULT NULL, company_logo VARCHAR(255) DEFAULT NULL, domain_name VARCHAR(255) DEFAULT NULL, contact_phone VARCHAR(255) DEFAULT NULL, primary_language VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
